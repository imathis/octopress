...
desc "Clean out caches: .pygments-cache, .gist-cache, .sass-cache, coverage reports, and Compass-generated files."
task :clean do
  rm_rf [".pygments-cache", ".gist-cache", "coverage", File.join(configuration[:source], "javascripts", "build")]
