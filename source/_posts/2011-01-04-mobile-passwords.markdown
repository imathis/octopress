...
<p style="text-align: center;"></p>
<p style="text-align: left;">Using the example pattern described above, you'd have to change to the 123-layout to enter the $ and 4, then to the ABC-layout for the Rfvbnm (making sure to tap shift for the R), and finally back to the 123-layout for the ending comma. Ugh.</p>
